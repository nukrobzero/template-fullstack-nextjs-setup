...
export default function Navbar() {
  ...
  return (
    <nav className="flex flex-wrap items-center justify-between bg-white top-0 z-50 sticky px-4 max-w-full mx-auto drop-shadow-md">
      <div>
        <Link href={`/`}>
          <Image
            src={`https://res.cloudinary.com/sumipol/image/upload/v1685069340/sumipol-web-image/Logo-SMP-Agile-Technology_sn98fc.webp`}
            width={68}
            height={80}
            alt="logo"
          />
      ...
      {menuOpen && (
        <>
          <div
            className="fixed top-0 left-0 w-full min-h-screen bg-black opacity-60 z-20"
            onClick={toggleCloseMenu}
          ></div>
          <div className="fixed top-0 right-0 w-2/3 min-h-screen bg-white z-30 border-r ease-in-out">
